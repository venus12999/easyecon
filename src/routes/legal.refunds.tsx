...
function RefundPolicy() {
  return <LegalPage title="退款政策" updated="2026 年 6 月 13 日">
    ...
    <LegalSection title="如何申请"><p>退款由我们的支付服务商 Paddle 处理。请前往 <a href="https://paddle.net" target="_blank" rel="noreferrer">paddle.net</a>，使用购买邮箱查询订单并提交申请；也可通过应用内反馈联系我们协助定位订单。</p></LegalSection>
