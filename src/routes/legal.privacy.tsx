...
function PrivacyNotice() {
  return <LegalPage title="隐私声明" updated="2026 年 6 月 13 日">
    ...
    <LegalSection title="2. 我们收集的数据"><p>我们处理邮箱、昵称和登录凭据；答题、错题、模考、AI 提问、上传答案及使用记录；支持消息；以及保障安全所需的 IP、设备和基础日志。为核对扫码付款，我们会保存你上传的付款截图、订单号、金额与付款渠道，我们不会存储完整银行卡信息。</p></LegalSection>
    ...
    <LegalSection title="4. 数据共享"><p>数据可与托管、认证、AI、存储和支持服务商共享；付款截图仅供销售方陈籽言 (Ziyan Chen) 及授权管理人员核对订单使用；也可在法律要求下与专业顾问或主管机关共享。我们不出售个人数据。</p></LegalSection>
