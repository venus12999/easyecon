...
export const Route = createFileRoute("/pricing")({
  head: () => ({
    meta: [
      { title: "EasyEcon Pro 定价｜月付 ¥29，年付 ¥199" },
      ...
      { property: "og:description", content: "月付 ¥29 或年付 ¥199，解锁 AI 讲解、FRQ 评分和不限次练习。" },
    ],
  }),
...
function PricingPage() {
  return (
    <main className="mx-auto w-full max-w-5xl px-4 py-12 sm:px-6 sm:py-16">
      ...
      <section aria-label="Pro 会员价格" className="mx-auto mt-10 grid max-w-3xl gap-4 sm:grid-cols-2">
        <Card>
          <CardHeader><CardTitle className="text-lg">Pro 月度会员</CardTitle></CardHeader>
          <CardContent>
            <p><span className="text-4xl font-bold">¥29</span><span className="text-muted-foreground"> / 月</span></p>
        ...
        <Card className="border-primary/40">
          <CardHeader>
            <div className="flex items-center justify-between gap-3">
              ...
              <span className="rounded-full bg-primary/10 px-3 py-1 text-xs font-semibold text-primary">更划算</span>
            </div>
          </CardHeader>
          <CardContent>
            <p><span className="text-4xl font-bold">¥199</span><span className="text-muted-foreground"> / 年</span></p>
            <p className="mt-3 flex items-center gap-1 text-sm text-muted-foreground"><Sparkles className="h-4 w-4 text-primary" aria-hidden="true" />相比月付每年节省 ¥149。</p>
          </CardContent>
        </Card>
      </section>
