...
function TermsOfService() {
  return <LegalPage title="服务条款" updated="2026 年 6 月 13 日">
    ...
    <LegalSection title="4. 订阅、付款与退款"><p>目前会员与辅导课通过微信支付 / 支付宝扫码转账完成，由销售方陈籽言 (Ziyan Chen) 直接收款并提供服务。你在付款后需在站内上传付款截图，我们人工核对后开通对应权益（通常 24 小时内）。所有方案均为一次性付款、不自动续费；到期后如需继续使用，请再次下单。金额与到期时间以站内“我的订单”记录为准。</p></LegalSection>
